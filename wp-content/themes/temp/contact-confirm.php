...
<head>
  ...
  <!-- og関連 -->
  <meta property="og:url" content="<?= site_url('confirm'); ?>/">
...
<div id="breadcrumbs">
  <ol itemscope itemtype="https://schema.org/BreadcrumbList">
    ...
    <li itemprop="itemListElement" itemscope
      itemtype="https://schema.org/ListItem">
      <a itemprop="item" href="<?= site_url('confirm');?>/">
        <span class="text_style" itemprop="name">CONFIRM</span>
      </a>
    ...
    <article class="main">
      <section class="contact">
        <div class="contact__inner">
          ...
          <h3 class="sub_title_style">内容確認</h3>
          <div class="contact_text">
            <p>以下フォームよりお気軽にお問い合わせください。</p>
            <p>お問い合わせ内容の確認後、担当者よりご連絡させていただきます。</p>
          </div>
          <?= do_shortcode('[contact-form-7 id="293721e" title="お問い合わせ（確認画面）"]'); ?>
        </div>
      </section>
    <?php get_footer(); ?>
